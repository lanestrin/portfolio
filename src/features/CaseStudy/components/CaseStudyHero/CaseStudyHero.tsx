        ...
        <div className={styles.heroLayout}>
          <div className={styles.heroContent}>
            <p className={styles.subtitle}>
              A multi-store commerce platform for shopping teamwear, launching
              branded storefronts, and building customized merchandise
              experiences.
            </p>
            ...
            <div className={styles.description}>
              <p>
                ...
                organization-owned stores for teams, clubs, schools, and
                coaches.
              </p>

              <p>
                The core shopping experience and public storefronts are
                available now. I am currently building a guided store-creation
                system that turns team colors, branding, and product selections
                into a ready-to-launch storefront.
              </p>
            </div>
