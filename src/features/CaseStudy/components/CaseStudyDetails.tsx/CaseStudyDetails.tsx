  ...
  return (
    ...
    >
      <div className="container">
        <h2 id="case-study-details-title" className={styles.visuallyHidden}>
        ...
        <div className={styles.cardGrid}>
          <article className={styles.card}>
            ...
            <p className={styles.cardIntro}>
              The product-generation system will combine organization branding
              with selected catalog items to produce storefront-ready
            ...
            <div className={styles.generationStatus}>
              <p>
                <strong className={styles.working}>Working now:</strong> Brand
                setup, guided navigation, color selection, and live storefront
                styling.
              </p>
              ...
              <p>
                ...
                Catalog mapping, artwork rules, product-generation logic, and
                merchandise previews.
              </p>
            </div>
          </article>
          ...
          <article className={styles.card}>
            ...
            <div className={styles.decisionList}>
              {systemDecisions.map(({ title, description, icon: Icon }) => (
                <div className={styles.decision} key={title}>
          ...
          <article className={styles.card}>
            ...
            <p className={styles.cardIntro}>
              I am designing and building TeamStore as a real-world portfolio
              product, focusing on clean architecture, scalable components, and
