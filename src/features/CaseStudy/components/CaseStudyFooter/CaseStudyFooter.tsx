        ...
        >
            <div className={`${styles.layout} container`}>
                <div className={styles.technology}>
                    <header className={styles.header}>
                        <h2 id="technology-title">
                            A Practical Frontend Foundation
                        </h2>

                        <p>
                            A modern React architecture with a clear data model,
                            real-time backend services, and scoped styling for a
                            scalable commerce experience.
                        </p>
                    </header>
                ...
                <div className={styles.demo}>
                    ...
                    <p>
                        View the completed commerce experience and the latest
                        progress on the TeamStore creation workflow.
                    </p>
