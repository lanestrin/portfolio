            ...
            <div className={`${styles.layout} container`}>
                <header className={styles.content}>
                    ...
                    <div className={styles.description}>
                        <p>
                            The Create Store Wizard is the guided workflow that
                            helps organizations launch a branded storefront.
                        </p>

                        <p>
                            Users select colors, define their organization,
                            choose products, configure settings, and publish
                            when ready.
                        </p>

                        <p>
                            The first working experience lets users choose team
                            colors and immediately see those choices reflected
                            in a live storefront preview.
                        </p>
                    </div>
                </header>
