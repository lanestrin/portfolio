		...
		roles: [
			{
				...
				bullets: [
					...
					"Modernized the frontend of a tightly coupled legacy .NET MVC cart and checkout workflow using **Vite and TypeScript**, reducing load times from approximately **8 minutes to under 30 seconds** while adding validation and safeguards against duplicate submissions.",
					...
					"Led implementation of an Adyen payment migration across **five legacy .NET and .NET MVC applications**, researching API request/response requirements and user-facing validation to support stronger payment security and retire the previous payment process.",
